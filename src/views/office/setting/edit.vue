    ...
    <div class="all-container-padding bg">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="基本信息" name="first">
          <el-form ref="EditorUserForms" :model="userlist" :rules="rules">
            <el-form-item :label-width="formLabelWidth" label="头像" prop="avatar_url">
              <el-upload
                ...
                action="shujiaoke.oss-cn-hangzhou.aliyuncs.com">
                <img v-if="userlist.avatar_url" :src="userlist.avatar_url" class="avatar">
                <i v-else class="el-icon-plus avatar-uploader-icon " style="width:80pxheight:80px"/>
              </el-upload>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户名" prop="username">
              <el-col :span="24">
                <el-input v-model="userlist.username" disabled/>
              </el-col>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="电话" prop="phone">
              <el-col :span="24">
                <el-input v-model="userlist.phone" placeholder="请输入电话"/>
              </el-col>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="邮箱" prop="email">
              <el-col :span="24">
                <el-input v-model="userlist.email" placeholder="请输入邮箱"/>
              </el-col>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户角色" prop="full_name">
              <el-col :span="24">
                <el-input v-model="userlist.full_name" disabled/>
              </el-col>
            </el-form-item>
          </el-form>
        ...
        <el-tab-pane label="修改密码" name="second">
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules">
            <el-form-item :label-width="formLabelWidth" label="原密码" prop="pass">
              <el-col :span="24">
                <el-input v-model="ruleForm.pass" placeholder="请输入原密码" type="password"/>
              </el-col>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="新密码" prop="newpass">
              <el-col :span="24">
                <el-input id="newkey" v-model="ruleForm.newpass" placeholder="请输入新密码" type="password"/>
              </el-col>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="重复新密码" prop="checknewpass">
              <el-col :span="24">
                <el-input
                  id=""
          ...
          <div class="grid-content bg-purple">
            <el-button type="primary" rule-form-click="submitForm(">保存</el-button>
          </div>
        </el-tab-pane>
      </el-tabs>
    </div>
